...
```{r}
gapminder[c(1,2,3,4,5), c(3,4)] # First five rows, 3rd and 4th col
```

```{r}
gapminder[1:5, 3:4] # First five rows, 3rd and 4th column
```
...
.small[
```{r}
yugoslavia$short_country <- 
  ifelse(
    yugoslavia$country == "Bosnia and Herzegovina","B and H",
